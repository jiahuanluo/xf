...
dense_features = ['user_id__size', 'user_id_ad_id_unique', 'user_id_creative_id_unique', 'user_id_advertiser_id_unique',
                  'user_id_industry_unique', 'user_id_product_id_unique', 'user_id_time_unique',
                  'user_id_click_times_sum', 'user_id_click_times_mean', 'user_id_click_times_std']
...
if __name__ == "__main__":
    ...
    for f, num in [('age', 10), ('gender', 2)]:
        ...
        test_df[out_fs].to_csv('submission/submission_test_{}_{}_{}.csv'.format(f, args.index, round(acc, 5)),
                               index=False)
