        ...
        for step, batch in enumerate(train_dataloader):
            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                if args.local_rank in [-1, 0] and args.save_steps > 0 and global_step % args.save_steps == 0:
                    ...
                    # 保存模型
                    model_to_save = model.module.encoder if hasattr(model,
                                                                    'module') else model.encoder  # Take care of distributed/parallel training
                    ...
                    model_to_save_embeddings = model.module.text_embeddings if hasattr(model,
                                                                                       'module') else model.text_embeddings
